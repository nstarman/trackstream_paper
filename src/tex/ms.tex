...
\section{Methods: Ordering the Data} \label{sec:ordering_the_data}
  ...
  \label{sub:great_circle_coordinate_frame}
    ...
    \begin{figure}
      ...
      \centering
      \hspace*{-10pt}
      \includegraphics[width=1.1\linewidth]{figures/method_frame-fit.pdf}
      \caption{ Simulation of \stream{NGC 5466} \citep{El-Falou2022}.
        %
        [top] \stream{NGC 5466} in an ICRS reference frame.
        %
        [middle] \stream{NGC-5466} in the best-fit rotated reference frame, with
  ...
  \subsection{Self-Organizing Maps} \label{sub:self_organizing_maps}
    ...
    \subsubsection{Projecting on the SOM} \label{sub:som_projection}
      ...
      \begin{figure}
        ...
        \caption{
          %
          \emph{Simulation of \stream{NGC-5466} ordered by SOM.}
          %
          The \stream{NGC-5466} simulation is the same as
      ...
      $\phi_1$, for example with phase-wrappings or in
      \autoref{fig:method_som-fit_solar-circle}, the binning is poor.}
...
\label{sec:kalman_filter}
  ...
  \subsection{Running the Kalman Filter} \label{sub:filter_setup}
    ...
    \begin{figure}
      ...
      \caption{
        %
        \emph{The Kalman-predicted path for \stream{NGC-5466}}.
        %
        Building on figures
  ...
  \label{sub:tracking_an_n_body_model}
    ...
    \begin{figure*}
      ...
      \caption{
        ...
        of \stream{Palomar 5}.} The mock stream progenitor parameters
        are for \stream{Palomar 5}, integrated in \galpyMWPotential.
        %
        [top left/right] x-y and $v_x$-$v_y$ projections of the simulated
        stream's arms and progenitor. The data are not yet ordered, beyond
        identifying to which stream arm each tail belongs.
  ...
  \label{sub:tracking_real_streams}
    ...
    \begin{figure}
      ...
      \caption{\label{fig:results_Pal5_real}
        ...
        \stream{Palomar 5} stream from \citet{Ibata2017} and mean track points
    ...
    \begin{figure}
      ...
      \caption{
        ...
        \stream{GD-1} dataset from \citet{Price-Whelan2018}} (blue and black
        points).
        %
